...
// endponts
const _ENDPOINT_REGISTER = _HOST + _PORT + "/auth/api/signup";
...
const _ENDPOINT_PROFILEAPPLICATIONS = _HOST + _PORT + "/restricted/adoptionlist";
const _PUBLIC_ENDPOINT_GETPETBYID = _HOST + _PORT + "/public/api/pet";
const _ADMIN_ENDPOINT_ADDPET = _HOST + _PORT + "/admin/add/pet";